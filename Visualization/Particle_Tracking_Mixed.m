...
% estimate the walking droplet position at any time.
%
% Inputs :
...
find_pixel2mm = 0; % defines the resolution
...
folder_name = 'C:\Users\Leblanc\Documents\IngeCivilMaster2\Memoire\Experiments\08-06-20\';

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Directory name
directory = '';
filename = '00073_f80_2200';
image_format = '.MTS';
ref_length = 0.085;
first_image = 500;
last_image = 50000;
...
if (find_pixel2mm)
    ...
    corr_size = round(1.2e-3/pixel2mm); % One droplet is more or less 1mm diameter
